...
/*   Updated: 2023/06/20 08:54:55 by kkaiyawo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_instruction(void)
{
	...
	{number_of_philosophers} (int) - The number of philosophers and also the
	number of forks.\n
	{time_to_die} (int) - If a philosopher didn't start eating time_to_die
	milliseconds since the beginning of their last meal or the beginning of
	the simulation, they die.\n
	{time_to_eat} (int) - The time in milliseconds it takes for a philosopher
	to eat. During that time, they will need to hold two forks.\n
	{time_to_sleep} (int) - The time in milliseconds the philosopher will
	spend sleeping.\n
	[number_of_times_each_philosopher_must_eat] (int) - If all philosophers
